...
const AnalizadorVrt_1 = require("./AnalizadorVrt");
const fs = require('fs');
const Report_1 = require("./Report");
var analizador = new AnalizadorVrt_1.AnalizadorVrt();
let datetime = new Date().toISOString().replace(/:/g, ".");
(() => __awaiter(void 0, void 0, void 0, function* () {
    return yield analizador.execTestVrt('./resultFunctionalTest', datetime).then(resultados => {
        let reportHtml = new Report_1.ReportHtml();
